...
const FolderCard: React.FC<FolderCardInterface> = ({ children, ...props }) => {
  return (
    <div className="w-full h-full p-4 rounded-md bg-linear-to-br from-accent-yellow/30 to-accent-blue/30 flex flex-col items-center justify-between gap-4 relative max-w-full">

  ...
  return (
    ...
    >
      <div className="w-full my-auto h-auto max-w-screen-l-s bg-neutral-100 shadow-md rounded-lg flex flex-col items-center justify-start">
        ...
        <div className="w-full p-4 grid grid-cols-1 items-start justify-start gap-4 l-s:grid-cols-2">
          <div className="w-full h-full flex flex-col items-center justify-start gap-4">
            ...
            <div className="flex flex-col items-start justify-center w-full gap-1">
              ...
              <div className="w-full p-2 px-4 rounded-md border-2 relative overflow-x-auto h-40 overflow-y-auto bg-white">
          ...
          <div className="w-full flex flex-col items-start justify-center gap-1">
            ...
            <div className="w-full flex flex-col gap-2 items-center justify-start overflow-y-auto max-h-60 l-l:max-h-64">
              {mappedSurveys}
            </div>
          </div>
        </div>
